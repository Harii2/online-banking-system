...
STATICFILES_STORAGE = 'online_banking_system.common.aws.custom_storages.StaticStorage'
DEFAULT_FILE_STORAGE = 'online_banking_system.common.aws.custom_storages.MediaStorage'
